...
-- Dumping data for table soft_uni.employees_projects: ~843 rows (approximately)
...
-- Dumping structure for table soft_uni.high_paid_empl
CREATE TABLE IF NOT EXISTS `high_paid_empl` (
...
-- Dumping data for table soft_uni.high_paid_empl: ~26 rows (approximately)
/*!40000 ALTER TABLE `high_paid_empl` DISABLE KEYS */;
INSERT INTO `high_paid_empl` (`employee_id`, `first_name`, `last_name`, `middle_name`, `job_title`, `department_id`, `manager_id`, `hire_date`, `salary`, `address_id`) VALUES
	(3, 'Roberto', 'Tamburello', NULL, 'Engineering Manager', 1, 12, '2018-02-11 11:16:09.497805', 48300.0000, 193),
	(6, 'David', 'Bradley', 'M', 'Marketing Manager', 5, 109, '2000-01-20 00:00:00.000000', 37500.0000, 199),
	(9, 'Gail', 'Erickson', 'A', 'Design Engineer', 1, 3, '2018-02-11 11:16:09.497805', 37700.0000, 22),
	(11, 'Jossef', 'Goldberg', 'H', 'Design Engineer', 1, 3, '2018-02-11 11:16:09.497805', 37700.0000, 214),
	(12, 'Terri', 'Duffy', 'Lee', 'Vice President of Engineering', 1, 109, '2018-02-11 11:16:09.497805', 68500.0000, 209),
	(28, 'Ashvini', 'Sharma', 'R', 'Network Administrator', 11, 150, '2001-01-05 00:00:00.000000', 32500.0000, 133),
	(42, 'Jean', 'Trenary', 'E', 'Information Services Manager', 11, 109, '2001-01-12 00:00:00.000000', 50500.0000, 194),
	(71, 'Wendy', 'Kahn', 'Beth', 'Finance Manager', 10, 140, '2001-01-26 00:00:00.000000', 43300.0000, 232),
	(79, 'Diane', 'Margheim', 'L', 'Research and Development Engineer', 6, 158, '2001-01-30 00:00:00.000000', 40900.0000, 111),
	...
	(188, 'Peter', 'Connelly', 'I', 'Network Administrator', 11, 150, '2001-03-27 00:00:00.000000', 32500.0000, 137),
	(217, 'Michael', 'Raheem', NULL, 'Research and Development Manager', 6, 158, '2001-06-04 00:00:00.000000', 42500.0000, 236),
	(267, 'Michael', 'Sullivan', 'I', 'Senior Design Engineer', 1, 3, '2018-02-11 11:16:09.497805', 41100.0000, 217),
	(268, 'Stephen', 'Jiang', 'Y', 'North American Sales Manager', 3, 273, '2003-02-04 00:00:00.000000', 48100.0000, 196),
	(270, 'Sharon', 'Salavaria', 'B', 'Design Engineer', 1, 3, '2018-02-11 11:16:09.497805', 37700.0000, 216),
	(273, 'Brian', 'Welcker', 'S', 'Vice President of Sales', 3, 109, '2003-03-18 00:00:00.000000', 72100.0000, 134),
	(284, 'Amy', 'Alberts', 'E', 'European Sales Manager', 3, 273, '2004-05-18 00:00:00.000000', 48100.0000, 202),
	(288, 'Syed', 'Abbas', 'E', 'Pacific Sales Manager', 3, 273, '2005-04-15 00:00:00.000000', 48100.0000, 49),
	(291, 'Svetlin', 'Nakov', 'Ivanov', 'Independent Software Development  Consultant', 6, NULL, '2005-03-01 00:00:00.000000', 48000.0000, 291),
	(292, 'Martin', 'Kulov', NULL, 'Independent .NET Consultant', 6, NULL, '2005-03-01 00:00:00.000000', 48000.0000, 291),
	(293, 'George', 'Denchev', NULL, 'Independent Java Consultant', 6, NULL, '2005-03-01 00:00:00.000000', 48000.0000, 291);
/*!40000 ALTER TABLE `high_paid_empl` ENABLE KEYS */;

-- Dumping structure for table soft_uni.manufacturers
CREATE TABLE IF NOT EXISTS `manufacturers` (
  `manufacturer_id` int(11) NOT NULL,
  `name` varchar(5) DEFAULT NULL,
  `established_on` datetime DEFAULT NULL,
  PRIMARY KEY (`manufacturer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table soft_uni.manufacturers: ~3 rows (approximately)
/*!40000 ALTER TABLE `manufacturers` DISABLE KEYS */;
INSERT INTO `manufacturers` (`manufacturer_id`, `name`, `established_on`) VALUES
	(1, 'BMW', '1916-03-01 00:00:00'),
	(2, 'Tesla', '2003-01-01 00:00:00'),
	(3, 'Lada', '1966-05-01 00:00:00');
/*!40000 ALTER TABLE `manufacturers` ENABLE KEYS */;

-- Dumping structure for table soft_uni.models
CREATE TABLE IF NOT EXISTS `models` (
  ...
  CONSTRAINT `models_ibfk_1` FOREIGN KEY (`manufacturer_id`) REFERENCES `manufacturers` (`manufacturer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table soft_uni.models: ~6 rows (approximately)
...
-- Dumping data for table soft_uni.projects: ~79 rows (approximately)
